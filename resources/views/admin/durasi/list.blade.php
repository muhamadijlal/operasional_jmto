...
<div class="card">
    <div class="card-datatable table-responsive pt-0">
        ...
        <div class="card-body">
            ...
            <button class="btn btn-info add-new  mb-5  " id="btnAddDurasi"> <i class="fa fa-plus"></i> Tambah Durasi</button>
            <button class="btn btn-secondary mb-5  " id="btnRefreshDurasi"> <i class="fa fa-refresh"></i> Refresh</button>
...
<script src="{{ asset('assets/js/admin/durasi.js') }}"></script>
