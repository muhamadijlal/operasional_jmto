...
/**
 * Koneksi: mysql2 (DB lokal gerbang). Petugas yang ditempatkan di gerbang ini
 * (berbeda dari mysql.tbl_pegawai yang berisi data pusat ruas).
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::connection('mysql2')->create('tbl_pegawai', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql2')->dropIfExists('tbl_pegawai');
    }
};
