...
class BuatPetugasUpdateStore extends FormRequest
{
    /**
    ...
    {
        return [
            'npp' => 'required|unique:tbl_pegawai,npp_no,' . $this->route('id'),
            'nama_petugas' => 'required',
            'jabatan' => 'required',
            'inisial_petugas' => 'required|unique:tbl_pegawai,kode_tugas,' . $this->route('id'),
